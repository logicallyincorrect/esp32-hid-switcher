...
int main(){
  Fixture f;assert(!f.push(1000));assert(f.push(1120));assert(f.e.target==1&&f.e.entry==1);assert(f.e.finish(1120)==-1);
  auto token=f.e.epoch;f.e.sample(1,{0,false,true,100,token-1},1130,1130);assert(f.e.finish(1130)==-1);
  f.sample(1,0,1150);assert(f.e.finish(1150)==1);assert(f.e.target==-1);
  Fixture left;left.sample(0,1,1000);assert(!left.e.motion(-12,0,1000,1000));assert(left.e.motion(-12,0,1120,1120));assert(left.e.target==2&&left.e.entry==2);
  ...
  Fixture skip;skip.sample(1,0,1000,false,false);skip.push(1000);assert(skip.push(1120)&&skip.e.target==2);
  ...
  Fixture revoked;revoked.push(1000);revoked.push(1120);revoked.sample(1,0,1130);revoked.sample(1,1,1140);assert(revoked.e.finish(1140)==-1);
  ...
  Fixture packet;packet.push(1000);packet.push(1120);uint8_t status[12];packet.e.packet(1,status);assert(status[3]==1&&status[10]==1&&EdgeProtocol::read32(status+6)==packet.e.epoch);packet.e.packet(2,status);assert(status[3]==0&&status[10]==0);
